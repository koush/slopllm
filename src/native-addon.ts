...
export interface NativeAddon {
  ...
  appendSelectedMtpCaches(ctx: number, mlaSrcCkvPtrs: number, mlaSrcKpePtrs: number, mlaDstCkvPtrs: number, mlaDstKpePtrs: number, mlaLayerCount: number, indexerSrcPtrs: number, indexerDstPtrs: number, indexerDstScalePtrs: number, indexerLayerCount: number, sourceRows: number, indices: number, indptr: number, batchIndices: number, positions: number, nnz: number, pageSize: number, kvLoraRank: number, peDim: number, indexHeadDim: number, sparseMode: boolean, cpWorldSize: number, cpRank: number): void;
