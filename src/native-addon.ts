...
export interface NativeAddon {
  ...
  fill(ctx: number, out: number, value: number, n: number, dtype: string): void;
  indexerScore(ctx: number, out: number, q: number, kData: number, kScaleData: number, weights: number, pageIndices: number, pageIndptr: number, lastPageLen: number, qoIndptr: number, scale: number, totalQ: number, idxNHeads: number, idxHeadDim: number, pageSize: number, maxKvLen: number, causal: number, kvTokenIndptr?: number): void;
  indexerScoreTopkPrefill(ctx: number, outIdx: number, outScores: number, q: number, kData: number, kScaleData: number, weights: number, pageIndices: number, pageIndptr: number, lastPageLen: number, qoIndptr: number, scale: number, totalQ: number, idxNHeads: number, idxHeadDim: number, pageSize: number, topk: number, causal: number, qGlobalStart: number, customMask: number, maskIndptr: number, maskKvLen: number, scores: number, rowLen: number, maxKv: number, coarseHist: number, fineHist: number, meta: number, queryTiles: number, cpWorldSize: number, cpRank: number, globalLastPageLen: number, kvTokenIndptr?: number, precomputedEw?: number): void;
  indexerScoreTopkV2(ctx: number, outIdx: number, outScores: number, q: number, kData: number, kScaleData: number, weights: number, pageIndices: number, pageIndptr: number, lastPageLen: number, qoIndptr: number, scale: number, totalQ: number, idxNHeads: number, idxHeadDim: number, pageSize: number, topk: number, causal: number, qGlobalStart: number, customMask: number, maskIndptr: number, maskKvLen: number, scores: number, rowLen: number, hist: number, meta: number, maxKv: number, numSplits: number, cpWorldSize: number, cpRank: number, globalLastPageLen: number, kvTokenIndptr?: number, precomputedEw?: number): void;
  indexerQuantizeQ(ctx: number, outQ8: number, outEw: number, q: number, weights: number, nHeads: number, weightsStride: number, weightsOffset: number, totalQ: number, scale: number): void;
  ...
  indexerKvCacheAppendFlat(ctx: number, kData: number, kScaleData: number, appendK: number, kvTokenIndptr: number, batchIndices: number, positions: number, nnz: number, headDim: number, appendStrideN: number): void;
  ...
  quantizeFp8(ctx: number, input: number, values: number, scales: number, numBlocks: number, blockSize: number): void;
  sparseMlaPrefill(ctx: number, qNope: number, qRope: number, kvCache: number, indices: number, output: number, outLse: number, numTokens: number, numHeads: number, topk: number, smScale: number, strideKvBlock: number, topkLength: number, qScales?: number): void;
  sparseMlaDecode(ctx: number, qNope: number, qRope: number, kvCache: number, indices: number, midOut: number, midLse: number, output: number, outLse: number, numTokens: number, numHeads: number, topk: number, numSplits: number, smScale: number, strideKvBlock: number, chunksPerBlock: number, topkLength?: number, qScales?: number): void;
  ...
  sampleBatch(ctx: number, outTokens: number, topkVals: number, topkIdxs: number, workspace: number, logits: number, penaltyTokens: number, penaltyCount: number, maxWindow: number, vocabSize: number, batchSize: number, temperatures: number, repPenalties: number, presPenalties: number, topKs: number, topPs: number, stepCounter: number, maxEffectiveK: number, outProbs?: number, outIds?: number, supportCapacity?: number): void;
  sampleCandidates(ctx: number, outTokens: number, outProbs: number, outIds: number, candidateValues: number, candidateIds: number, temperatures: number, topKs: number, topPs: number, stepCounter: number, batchSize: number, candidateCount: number, supportCapacity: number): void;
  specRejectLinear(ctx: number, outTokens: number, outAccepted: number, draftTokens: number, qProbs: number, qIds: number, pProbs: number, pIds: number, stepCounter: number, batchSize: number, depth: number, capacity: number): void;
  ...
  bmm(ctx: number, C: number, A: number, B: number, alpha: number, beta: number, batch: number, M: number, N: number, K: number, transA: number, transB: number, tokenMajor: boolean, workspace: number, workspaceSize: number): void;
  mlaVExpand(ctx: number, result: number, attnOut: number, vProj: number, kvLoraRank: number, vHeadDim: number, nHeads: number, seqLen: number, batch: number, attnNHeads: number, headOffset: number, vProjHeadOffset: number, workspace: number, workspaceSize: number): void;
  ...
  p2pAllGatherTwoWrite(ctx: number, a: number, b: number, outputsA: number[], outputsB: number[], N: number, rowBytesA: number, outerA: number, rowBytesB: number, outerB: number, rank: number): void;
